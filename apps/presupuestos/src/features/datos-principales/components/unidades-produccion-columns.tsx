...
import { type UnidadProduccion } from './unidades-produccion-data'

export const unidadesProduccionColumns: ColumnDef<UnidadProduccion>[] = [
  {
    accessorKey: 'id',
    header: 'Id',
    cell: ({ row }) => (
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className='max-w-[200px] truncate'>{row.getValue('nombre')}</div>
    ),
  },
  {
