...
import { IndiceUnificadoCard } from './indice-unificado-card'
...
export default function IndicesUnificadosCards() {
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <div className="relative">
            ...
            <Input
              placeholder="Buscar índices unificados"
              value={searchTerm}
      ...
      {filteredData.length === 0 ? (
        ...
        <div className='grid grid-cols-1 gap-3'>
          {filteredData.map((indiceUnificado) => (
            <IndiceUnificadoCard key={indiceUnificado.codigo} indiceUnificado={indiceUnificado} />
          ))}
        </div>
      )}
    </div>
