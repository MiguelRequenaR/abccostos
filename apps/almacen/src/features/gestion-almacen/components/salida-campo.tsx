...
interface SalidaCampo {
  id: string
  fecha: string
  trabajo: string
  recibe: string
  estado: 'Entregado' | 'Pendiente' | 'Entrega Parcial' | 'Rechazado' | 'Cerrado'
  observacion: string
}

const getEstadoStyles = (estado: SalidaCampo['estado']) => {
  switch (estado) {
    case 'Pendiente':
...
export default function SalidaCampo() {
